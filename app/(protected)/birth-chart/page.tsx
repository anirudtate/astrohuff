  ...
  const onSubmit = async (data: BirthChartData) => {
    try {
      ...
      const requestBody = {
        ...
        // Only fetch planetary positions
        ...
        "https://json.freeastrologyapi.com/planets",
        {
          ...
          "x-api-key": process.env.NEXT_PUBLIC_ASTROLOGY_API_KEY ?? '',
          },
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {Object.entries(chartData.output[1])
                  .filter(([key]) => !["debug", "13"].includes(key))
                    .map(([name, planet]: [string, { 
                    current_sign: number;
                    normDegree: number;
                    fullDegree: number;
                    isRetro: string;
